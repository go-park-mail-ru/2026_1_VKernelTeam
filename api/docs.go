...
const docTemplate = `{
    ...
    "basePath": "{{.BasePath}}",
    "paths": {
        "/admin/moderation/ads/{id}/approve": {
            "post": {
                "security": [
                    {
                        "CookieAuth": []
        ...
        "/admin/moderation/ads/{id}/reject": {
            "post": {
                "security": [
                    {
                        "CookieAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.moderationFlagBody"
                        }
                    }
                ],
                "responses": {
        ...
        "/test/reset": {
            "post": {
                ...
                "responses": {
                    ...
                    "403": {
                        "description": "only test users can reset data",
                        "schema": {
                            "$ref": "#/definitions/dto.ErrorResponse"
                        }
                    },
